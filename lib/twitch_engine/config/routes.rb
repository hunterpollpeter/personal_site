TwitchEngine::Engine.routes.draw do
  ...
  get 'overlays/new/:name', to: 'overlays#create', as: :create_twitch_overlay
  ...
  get 'templates/:name/preview', to: 'overlays#preview_template', as: :twitch_overlay_template_preview
